ItemEvents.modification(e => {
  e.modify('minecraft:netherrack', item => {
    item.fireResistant = true
  })
  e.modify('minecraft:nether_bricks', item => {
    item.fireResistant = true
  })
  ...
  e.modify('nyagibits_bytes:porous_insulating_firebrick', item => {
    item.fireResistant = true
  })
  e.modify('botania:endoflame', item => {
    item.fireResistant = true
  })
